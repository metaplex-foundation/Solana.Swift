...
public extension Solana {
    ...
    struct ConfirmedTransactionFromBlock: Decodable {
...
public extension Solana.ConfirmedTransactionFromBlock {
    struct MessageWithAccountKeys: Decodable {
        public let accountKeys: [String]
        public let instructions: [Solana.ParsedInstructionFromBlock]
        public let recentBlockhash: String
    }
}
public extension Solana {
    ...
    struct ParsedInstructionFromBlock: Decodable {
        struct Parsed: Decodable {
            struct Info: Decodable {
                let owner: String?
                let account: String?
